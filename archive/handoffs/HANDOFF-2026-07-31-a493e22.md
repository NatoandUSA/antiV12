> **ARCHIVED — IMMUTABLE.** This is the handoff note exactly as it was reviewed on 2026-07-31
> (repo HEAD `a70bdb0`, describing branch HEAD `a493e22`). It is kept unedited so the review that
> produced `AMZ_FBM_TOOLKIT_HANDOFF_REVIEW_FEEDBACK.json` can be checked against what it reviewed.
> Several claims below were subsequently corrected — see `HANDOFF-CURRENT.md`.

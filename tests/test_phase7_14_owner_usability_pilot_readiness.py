            ...
            "workflow": envelope({
                ...
                "trust": {"state": "HISTORICAL",
                         "reason": "Quarantined -- readable as history, never a basis for a new "
                                   "decision."},
                # DASHBOARD-V1-SPEC.md Section 13 item 4 -- Product Truth is deliberately NOT
                # READY here so stage 8's blocked_by_product_truth field below has something real
                # to point at; the derivation itself is covered directly in ProductTruthPrerequisite
                # (Python), this fixture only needs to prove the DOM renders whatever it's sent.
                "product_truth": {"label": "Product Truth", "group": "Build",
                                 "state": "OWNER_INPUT_REQUIRED",
                                 "command": "python scripts/phase6a_build.py <run_dir>",
                                 "staff_note": "Product Truth required before Listing + A+."},
                "stages": [
                    ...
                    {"stage_id": 2, "label": "Import Amazon + Xray", "group": "Research",
                     ...
                     "blocked_by_product_truth": False,
                    ...
                    # state stays NOT_ACCEPTED (not BLOCKED) so the six-distinct-states fixture
                    # below (workflow_state_by_stage) still covers all six -- blocked_by_product_
                    # truth is an independent field a stage can carry alongside any non-READY state.
                    {"stage_id": 8, "label": "Keywords -> listing", "group": "Build",
                     "modeled": True, "state": "NOT_ACCEPTED", "components": {}, "blocked_by": [],
                     "blocked_by_product_truth": True,
                    ...
                    {"stage_id": 9, "label": "Listing + A+", "group": "Build", "modeled": True,
                     ...
                     "blocked_by": [], "blocked_by_product_truth": False,

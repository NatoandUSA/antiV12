...
# ---- Phase 7.10 connected public research (SSRF + Amazon public-product boundary) ------
# The public-research surface adds a strict SSRF model on top of the permanent Amazon-account
# boundary above (which still wins first, in every path): no URL userinfo, no raw public IP
# literal, no private/loopback/link-local/reserved/metadata destination, and an Amazon US
# public product page must be a genuine product-detail path (any other Amazon path is refused).
URL_USERINFO_BLOCKED = "URL_USERINFO_BLOCKED"
IP_LITERAL_BLOCKED = "IP_LITERAL_BLOCKED"
PRIVATE_DESTINATION_BLOCKED = "PRIVATE_DESTINATION_BLOCKED"
AMAZON_NON_PRODUCT_PATH_BLOCKED = "AMAZON_NON_PRODUCT_PATH_BLOCKED"
AMAZON_PRODUCT_URL_INVALID = "AMAZON_PRODUCT_URL_INVALID"
...
ERROR_CODES = frozenset({
    ...
    AMAZON_NON_PRODUCT_PATH_BLOCKED, AMAZON_PRODUCT_URL_INVALID,
})
